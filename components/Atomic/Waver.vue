...
<template>
    ...
    <svg class="w-full h-fit" width="578" height="528" viewBox="0 0 578 528" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            fill="url(#paint0_linear_4494_331)" />
        <defs>
            <linearGradient id="paint0_linear_4494_331" x1="-43" y1="473.594" x2="510.347" y2="595.899"
